...
import { DeleteModal } from "@/features/vouchers/components/DeleteModal";
import { SummaryCards } from "@/features/vouchers/components/SummaryCards";
...
export default function VouchersPage() {
  ...
  return (
    <MainLayout currentPage="voucher">
